import { JSONData, NotionUserType, LoadPageChunkData, CollectionData, NotionSearchParamsType, NotionSearchResultsType } from './types';
...
const fetchNotionData = async <T extends any>({ resource, body, notionToken }: INotionParams): Promise<T> => {
...
export const fetchTableData = async (collectionId: string, collectionViewId: string, notionToken?: string) => {
